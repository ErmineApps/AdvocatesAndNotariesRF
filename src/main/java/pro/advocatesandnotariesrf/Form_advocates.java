...
import pro.advocatesandnotariesrf.advocates.Advocate_filter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.start_dialog_form_but_2).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Form_advocates.this, pro.advocatesandnotariesrf.AddQuestion.class));
            }
        });
        findViewById(R.id.start_dialog_form_but_3).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Form_advocates.this, pro.advocatesandnotariesrf.consultation.consultation_online.class));
            }
        });
        findViewById(R.id.start_dialog_form_but_4).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Form_advocates.this, pro.advocatesandnotariesrf.doc_create.Vid_create_doc.class));
            }
        });
        ...
        findViewById(R.id.start_dialog_form_but_close).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Form_advocates.this, pro.advocatesandnotariesrf.start_help.Start_activity_no_login.class));
            }
        });
    }
    @Override
